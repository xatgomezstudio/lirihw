...
var spotify = new Spotify({
    ...
    secret: "f5c98ac5366c4c4e86884c1a90950566"
});
...
function omdbApi() {
    ...
    axios.get('http://www.omdbapi.com/?apikey=' + omdbKey + '&t=' + request)
...
function spotifyApi() {
    ...
    spotify.search({ type: 'track', query: request, limit: 1 })
        .then(function (response) {
...
function getConcert() {
    ...
    axios.get("https://rest.bandsintown.com/artists/" + request + "/events?app_id=codingbootcamp").then(
        function (response) {
            console.log("\n\n Venue: " + response.data[0].venue.name + "\n City: " + response.data[0].venue.city + ", " + response.data[0].venue.country + "\n Date: " + response.data[0].datetime + "\n\n");
        })
